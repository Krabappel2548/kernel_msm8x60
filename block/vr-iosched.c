...
*/
static void vr_add_request(struct request_queue *q, struct request *rq)
{
...
*/
static void vr_remove_request(struct request_queue *q, struct request *rq)
{
struct vr_data *vd = vr_get_data(q);
...
*/
static void vr_move_request(struct vr_data *vd, struct request *rq)
{
...
static int vr_dispatch_requests(struct request_queue *q, int force)
{
struct vr_data *vd = vr_get_data(q);
...
static ssize_t vr_var_store(int *var, const char *page, size_t count)
{
